...
R also has a built-in exponential distribution with pdf `dgamma`, which can be sampled with `rgamma`. We can test that this matches our implementation using a one-sample [Kolmogorov-Smirnov test](https://en.wikipedia.org/wiki/Kolmogorov%E2%80%93Smirnov_test):
